  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.dots}>
        <FontAwesomeIcon
          className={
            slide === 1 ? styles.icon_dot_blue_light : styles.icon_dot_blue_dark
          }
          icon={faCircle}
        />
        <FontAwesomeIcon
          className={
            slide === 2 ? styles.icon_dot_blue_light : styles.icon_dot_blue_dark
          }
          icon={faCircle}
        />
        <FontAwesomeIcon
          className={
            slide === 3 ? styles.icon_dot_blue_light : styles.icon_dot_blue_dark
          }
          icon={faCircle}
        />
      </div>
