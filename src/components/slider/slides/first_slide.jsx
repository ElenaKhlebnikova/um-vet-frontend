    ...
    <div className={styles.container_slide}>
      ...
      <div className={styles.info_container}>
        ...
        <p className={styles.text}>
          Welcome to UmVet! We&apos;ve been providing our clients with the best
          vet service since 2010!
          <ul>
            In our clinic we provide you with:
            <li>
              <FontAwesomeIcon className={styles.icon} icon={faStethoscope} />
              Best veterinary care
            </li>
            <li>
              <FontAwesomeIcon className={styles.icon} icon={faCookieBite} />
              Treat jar
            </li>
            <li>
            ...
            <li>
              <FontAwesomeIcon className={styles.icon} icon={faShieldCat} />
